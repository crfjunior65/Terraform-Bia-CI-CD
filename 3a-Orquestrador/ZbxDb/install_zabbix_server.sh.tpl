...
sudo apt -y install binutils rustc cargo pkg-config libssl-dev
cd /home/ubuntu/Install
...
aws s3 cp s3://crfjunior-bucket/server.sql.gz /home/ubuntu/Install/
sudo chown -R ubuntu:ubuntu /home/ubuntu/*
...
sudo zcat /home/ubuntu/Install/server.sql.gz | mysql --default-character-set=utf8mb4 -h${ZABBIX_DB_SERVER} -D${ZABBIX_DB_NAME} -u${ZABBIX_DB_USER} -p${ZABBIX_DB_PASS}
